#!/usr/bin/env python
"""
Package metadata for lmedxanalytics.
"""
import os
import re
import sys
...
VERSION = get_version('lmedxanalytics', '__init__.py')
...
setup(
    name='LMEdxAnalytics',
    version=VERSION,
    description="""User and Teacher Analytics on Openedx""",
    long_description=README + '\n\n' + CHANGELOG,
    author='edX',
    author_email='oscm@edx.org',
    url='https://github.com/openedx/LMEdxAnalytics',
    packages=find_packages(
        include=['lmedxanalytics', 'lmedxanalytics.*'],
        exclude=["*tests"],
    ),
