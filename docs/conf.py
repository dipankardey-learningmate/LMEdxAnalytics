...
"""
LMEdxAnalytics documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'LMEdxAnalytics',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/LMEdxAnalytics",
...
#
# html_title = 'LMEdxAnalytics v1.0.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'User and Teacher Analytics on Openedx',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'lmedxanalytics'),
                os.path.join(root_path, 'lmedxanalytics/migrations')])
